...
### Added
- Queue measuring mostly for Laravel
...
### Fixed
- Issue with irratic CPU measuring

## [v3.0.6] - 2024-01-03

### Fixed
- Issue with CPU spikes

## [v3.0.5] - 2023-11-24

### Changed
- Less spam of bad connections
...
### Fixed
- Isssue with performance timing
...
### Fixed
- Issue with needing threat info
...
### Changed
- Improved CPU accuracy - again

## [v2.10.0] - 2023-03-06

### Changed
- Improved CPU accuracy

## [v2.9.0] - 2023-03-06

### Changed
- The way CPU is measured - one last time
